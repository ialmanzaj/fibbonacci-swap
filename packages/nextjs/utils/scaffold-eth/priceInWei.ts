...
export function multiplyTo1e18(tokens: string | BigNumber): BigNumber {
...
export function getTokenPriceInWei(tokens: string | BigNumber, tokensPerEth?: BigNumber): BigNumber {
